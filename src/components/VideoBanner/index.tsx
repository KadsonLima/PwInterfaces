import { Box, Text, SimpleGrid, AspectRatio, Flex } from "@chakra-ui/react";
  ...
  return (
    <Box marginBottom={50}>
      ...
      >
        ...
        <AspectRatio ratio={16 / 9}>
          <iframe
            width="100%"
            height="100%"
            src={`https://www.youtube.com/embed/BWAOmY_IU1o`}
            title="YouTube video"
            allowFullScreen
          ></iframe>
        </AspectRatio>
      ...
      <Box px={4} textAlign={"center"}>
        <Flex justifyContent={"center"}><ButtonCopy link={"KasHUB.exe"} texto="Baixar Software" /></Flex>
