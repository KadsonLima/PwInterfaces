...
export const ProductPage: React.FC = () => {
  ...
  const dataUi = products[Number(id)];  
  const array = dataUi.images;

  const images =  array.map((image) =>{ return <Box width="100%">
    <img
      src={image}
      alt="Imagem 1"
      width="100%"
      ...
      <Flex p={4} flexDirection="column" justifyContent="space-evenly" alignItems="center" textAlign="center">
        <Heading as="h1" mb={4}>
          ...
          <Flex alignItems="center"  justifyContent="space-evenly" marginBottom={10}>
            ...
            <Image width="150px" src={pix} alt="chave pix 903386eb-8cfe-43bd-905d-6ef809dbcfd1" border={"2px solid #9d1111"}/>
            <Box p={4}>
              <Text>Pagamento</Text>
